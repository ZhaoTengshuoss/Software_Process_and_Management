 ...
 <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll" >
      ...
      <ul class="layui-nav layui-nav-tree" lay-filter="test">
        ...
        <li class="layui-nav-item"><a href="teacher.jsp" style="height:50px;font-size:20px;">老师信息查看</a></li>
...
%>
 <div class="layui-body">
	...
	<div class="my-btn-box" style="margin:10px 10px 10px 10px">
	    <span style="float:right">
	        ...
	        <div class="layui-input-inline">
	            <input type="text" autocomplete="off" placeholder="请输入老师姓名或工号号" class="layui-input" name="content">
	        </div>
    ...
    <table class="layui-table">
		...
		%>
		<tr>
			<td style="font-size:30px;text-align:center;"><a href="tp_info.jsp?tno=<%=user.getTno()%>"> <span style="color:blue;font-size:25px"><%=user.getTno() %></span></a></td>
