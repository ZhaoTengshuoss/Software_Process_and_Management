...
<%
  ...
  User user=userDao.find_t(login_nickname);
 
  if(session.getAttribute("tno1")==null)
  {
  session.setAttribute("tno1",user.getTno());
  }
  ...
  <div class="layui-row layui-col-space15">
    <div class="layui-col-md6">
      <div class="layui-card">
        <div class="layui-card-header">功能简介(学生)</div>
        <div class="layui-card-body">
    <table class="layui-table" style="color:blue;font-weight:bold;" lay-skin="row" lay-even="">
     <tr>
       <td>
                    ①.查看课程 （课程基本信息，考试成绩）。
      </td>
    ...
    <div class="layui-col-md6">
      <div class="layui-card">
        <div class="layui-card-header">功能简介(老师)</div>
        <div class="layui-card-body">
        <table class="layui-table" lay-even="" lay-skin="row"style="color:blue;font-weight:bold;">
           <tr>
       <td>
