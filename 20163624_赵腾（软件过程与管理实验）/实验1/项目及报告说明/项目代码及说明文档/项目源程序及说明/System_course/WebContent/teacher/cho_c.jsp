  ...
  <div class="layui-header" style="height:60px">
    ...
    <ul class="layui-nav layui-layout-left">
      <li class="layui-nav-item"><a style="font-size:20px" href="info.jsp">首页</a></li>
       ...
       <li class="layui-nav-item"><a style="font-size:20px" href="info.jsp">学生信息</a></li>
    </ul> 
...
<form action="cho_c1.jsp">
       <table class="layui-table">
		...
		<tr>
			...
			<td style="font-size:30px;text-align:center;"><a href=""> <span style="color:blue;font-size:25px"><%=user.getTno() %></span></a></td>
			<% 
			flag=true;
			String data=null;
