...
//筛选
    ...
    List<User> users = userDao.load2(content); 
    
    int id2;
    String ID;
    if(request.getParameter("tno1")==null)
    {
     id2=(int)session.getAttribute("tno1");

    }
    else
    {
    id2=Integer.parseInt(request.getParameter("tno1"));
    }
...
%>
 <div class="layui-body">
	...
	<div class="my-btn-box" style="margin:10px 10px 10px 10px">
	    <span style="float:left;">
	       <!--  <a class="layui-btn layui-btn-danger radius btn-delect" id="btn-delete-all">批量删除</a> -->
	        <a class="layui-btn btn-add btn-default" id="btn-add" href="add_c.jsp">添加新课程</a>    
	    </span>
	    <span style="float:right">
	        <span class="layui-form-label">搜索条件：</span>
	        <div class="layui-input-inline">
	            <input type="text" autocomplete="off" placeholder="请输入课程名或课程号" class="layui-input" name="content">
	        </div>
    ...
    <table class="layui-table">
			...
			<th style="font-size:30px;text-align:center;">课程性质</th>
			<th style="font-size:30px;text-align:center;">课程老师</th>
		...
		<tr>
			...
			<td> <a href="delete1.jsp?id2=<%=user.getCno()%>"><span style="color:blue;font-size:30px">删除</span></a></td>
			<td> <a href="updateInput2.jsp?id2=<%=user.getCno() %>"><span style="color:blue;font-size:30px">修改</span></a></td> 
			<td> <a href="show_s.jsp?id2=<%=user.getCno() %>"><span style="color:blue;font-size:30px">查看课程选课情况</span></a></td>
