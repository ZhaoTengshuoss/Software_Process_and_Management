...
//筛选
    ...
    List<User> users = userDao.load3(content); 
...
%>
 <div class="layui-body">
	...
	<div class="my-btn-box" style="margin:10px 10px 10px 10px">
	    <span style="float:right">
	        ...
	        <div class="layui-input-inline">
	            <input type="text" autocomplete="off" placeholder="请输入老师姓名或工号" class="layui-input" name="content">
	        </div>
    ...
    <table class="layui-table">
			<thead>
			<tr>
			<th style="font-size:30px;text-align:center;">老师工号</th>
			<th style="font-size:30px;text-align:center;">老师姓名</th>
			<th style="font-size:30px;text-align:center;">老师性别</th>
			<th style="font-size:30px;text-align:center;">老师年龄</th>
			<th style="font-size:30px;text-align:center;">老师院系</th>
		...
		%>
		<tr>
			<td style="font-size:30px;text-align:center;"><a href="tp_info3.jsp?tno=<%=user.getTno()%>"> <span style="color:blue;font-size:25px"><%=user.getTno() %></span></a></td>
			<td style="font-size:30px;text-align:center;"> <%=user.getTname()%></td>
			<td style="font-size:30px;text-align:center;"> <%=user.getTsex()%></td>
			<td style="font-size:30px;text-align:center;"> <%=user.getTage() %></td>
			<td style="font-size:30px;text-align:center;"> <%=user.getTdept() %></td>
			<td> <a href="delete_t.jsp?t_id=<%=user.getTno() %>&&t_username=<%=user.getUsername() %>"><span style="color:blue;font-size:30px">删除</span></a></td>
			<td> <a href="updateInput_t.jsp?t_id=<%=user.getTno() %>"><span style="color:blue;font-size:30px">修改</span></a></td>
		</tr>
		<%
			}                                                 
		%>
