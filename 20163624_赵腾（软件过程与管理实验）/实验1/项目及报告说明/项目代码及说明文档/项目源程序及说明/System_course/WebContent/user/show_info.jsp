...
User t_user=userDao.find_t(username);
    int tno=t_user.getTno();
  ...
  <div class="layui-col-md6">
      <div class="layui-card">
		...
		<tr>
			...
			<td><%=user.getXklb() %></td>
			<td> <a href="show_t_info.jsp?c_id=<%=user.getCno()%>"><span style="color:blue;font-size:15px">查看课程信息</span></a></td>
