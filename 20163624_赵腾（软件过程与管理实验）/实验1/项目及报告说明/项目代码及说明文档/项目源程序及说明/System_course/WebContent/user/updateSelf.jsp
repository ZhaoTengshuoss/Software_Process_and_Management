...
<%
    ...
    boolean flag1=true;
     ...
     if(user.getU_type()==1)
     {
     userDao.update_user_s(user,o_username);
     }
     else if(user.getU_type()==2)
     {
    	 userDao.update_user_t(user,o_username); 
     }
     else
     {
    	 userDao.update_user_u(user); 
     }
     ...
     if(user.getU_type()==1)
     {
     response.sendRedirect("../student/myself.jsp");
     }
     else if(user.getU_type()==2)
     {
       response.sendRedirect("../teacher/myself.jsp");
     }
     else
     {
