...
<div class="layui-layout layui-layout-admin" >
 ...
 <div class="layui-side layui-bg-black">
  ...
  <div class="layui-body">
   ...
   <a><cite>提交课程成绩</cite></a>
   </span>
   </div>
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
    <legend>提交课程成绩</legend>
    </fieldset>
<%
...
ID=request.getParameter("id2");
   ...
   session.setAttribute("ID", ID);//装载课程信息  
...
<form action="post_score1.jsp">
       <table class="layui-table">
		...
		%>
		<tr>
			<input type="hidden" name="Sno<%=i%>" value="<%=user.getSno()%>"/>
			...
			<td style="font-size:30px;text-align:center;">  <input type="text" name="Score<%=i++%>" value="<%=user.getGrade()%>"/></td>
			<%-- <td> <a href="delete.jsp?id=<%=user.getCno()%>"><span style="color:blue;font-size:30px">删除</span></a></td>
			<td> <a href="updateInput.jsp?id=<%=user.getCno() %>"><span style="color:blue;font-size:30px">修改</span></a></td>
		 --%>
		</tr>
		<%
			}  
