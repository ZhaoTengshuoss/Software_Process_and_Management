...
<div class="layui-layout layui-layout-admin" >
 ...
 <div class="layui-side layui-bg-black">
  ...
  <div style="margin-top:10px;margin-left:20px;margin-bottom:10px;">
   ...
   <a><cite>修改用户资料</cite></a>
   </span>
   </div>
  <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
    <legend style="color:red;font-size:25px;">修改用户资料</legend>
    </fieldset>
    ...
    String Meg=(String)session.getAttribute("INFO");
       ...
       int id;
       System.out.println("555:"+request.getParameter("u_id"));
       if(request.getParameter("u_id")!=null)
       {
       	session.setAttribute("u_id", request.getParameter("u_id"));
       }
       id=Integer.parseInt((String)session.getAttribute("u_id"));
       UserDaoImpl userDao = new UserDaoImpl();
       User user=userDao.find_user_u(id);      
%>
<form class="layui-form" action="./do_updateInput_u.jsp"  onsubmit="return tijiao()">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" id="username" name="username" value="<%=user.getUsername()%>" onfocus="userGetFocus()" onblur="userLoseFocus()" class="layui-input"style="font-size:20px;width:400px;height:50px;color:gray"/><br/><span id="user_span"></span><br/>
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label" style="width:100px"><h2>密码:</h2></label>
    <div class="layui-input-inline">
     <input type="text" id="password" name="password" onfocus="passGetFocus()" onblur="passLoseFocus()" value="<%=user.getPassword()%>" class="layui-input"style="font-size:20px;width:400px;height:50px;color:gray"/><br/><span id="pass_span"></span><br/>
    </div>
    <br><br><br>
    <div class="layui-form-item">
