...
{
session.setAttribute("id2",request.getParameter("id2"));
...
<div class="my-btn-box" style="margin:10px 10px 10px 10px">
    <span style="float:left;">
       <!--  <a class="layui-btn layui-btn-danger radius btn-delect" id="btn-delete-all">批量删除</a> -->
        <a class="layui-btn btn-add btn-default" id="btn-add" href="post_score.jsp?id2=<%=ID%>">提交成绩</a>
    </span>
</div>
<div class="my-btn-box" style="margin:20px 10px 10px 10px">
    <span style="float:left;margin-left: 20px;">
       <!--  <a class="layui-btn layui-btn-danger radius btn-delect" id="btn-delete-all">批量删除</a> -->
        <a class="layui-btn btn-add btn-default" id="btn-add" href="show_s2.jsp?id2=<%=ID%>">添加学生</a>
    </span>
